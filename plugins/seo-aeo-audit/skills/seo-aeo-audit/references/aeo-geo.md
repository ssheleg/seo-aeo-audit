...
| Alice AI / Алиса (Yandex) | Yandex index. 42% of Search queries now get an Alice AI answer, up from low single digits in two years and up 7pp in a quarter, with 49.5M monthly users of the quick answers under the search box (Q2'26 report, 2026-07-29 — figures and the prior quarter in benchmarks.md) and Search volume still growing >5% YoY; ~10% of Alice AI queries are product-related. Yandex Commerce Protocol places products inside answers with in-chat checkout: 1,600+ merchants applied and 200+ integrating as of 2026-05; restaurant and salon booking inside the chat shipped 2026-06. Ads inside the AI answer are in live experiments and were confirmed as a future buyable format (Forbes interview, 2026-04) | For RU commerce, YCP integration is a distribution decision, not an SEO one. Do not model the surface as organic-only — part of the answer real estate is becoming paid. RU field survey (2026-05): ChatGPT leads on awareness and usage but Alice AI drives roughly **5×** more clicks to sites, so RU prompt sets that skip it measure the wrong engine |
